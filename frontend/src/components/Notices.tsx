      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-sans text-muted-foreground max-w-xl mx-auto text-sm sm:text-base">
            Stay updated with the latest announcements, events, and important information from the school.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-16 gap-4">
              ...
              <p className="font-sans text-muted-foreground text-sm">Loading notices...</p>
            </div>
          )}
          ...
          {isError && (
            <div className="flex flex-col items-center justify-center py-16 gap-4">
              ...
              <p className="font-sans text-muted-foreground text-sm">Unable to load notices. Please try again later.</p>
            </div>
          )}
          ...
          {!isLoading && !isError && notices && notices.length === 0 && (
            <div className="flex flex-col items-center justify-center py-16 gap-4 border border-dashed border-border rounded-sm">
              ...
              <div className="text-center">
                <p className="font-serif font-semibold text-foreground mb-1">No notices at this time</p>
                <p className="font-sans text-muted-foreground text-sm">Check back later for school announcements and updates.</p>
              </div>
            </div>
          )}
