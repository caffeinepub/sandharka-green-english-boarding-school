import { GraduationCap, Heart, MapPin, Phone, Mail } from 'lucide-react';
...
export default function Footer() {
  ...
  const appId = encodeURIComponent(typeof window !== 'undefined' ? window.location.hostname : 'sandharka-green-school');
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="font-serif font-bold text-base leading-tight">Sandharka Green</div>
                <div className="text-gold-300 text-xs font-sans tracking-wider">English Boarding School</div>
              </div>
            </div>
            <p className="font-sans text-white/60 text-sm leading-relaxed max-w-xs mb-4">
              Nurturing excellence and building character since 2063 B.S. Providing quality English-medium education in the heart of Arghakhanchi, Nepal.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif font-bold text-base mb-4 text-gold-300">Quick Links</h4>
          ...
          {/* School Info */}
          <div>
            <h4 className="font-serif font-bold text-base mb-4 text-gold-300">School Info</h4>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-sans text-white/40 text-xs text-center sm:text-left">
            © {year} Sandharka Green English Boarding School. All rights reserved.
          </p>
