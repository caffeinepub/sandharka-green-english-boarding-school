  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/assets/generated/sandharka_green_english_boarding_school.jpg')`,
        }}
      />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto pt-20">
        ...
        <h1
          ...
          style={{ animationDelay: '0.1s', fontSize: 'clamp(2rem, 6vw, 4.5rem)' }}
        >
          Sandharka Green
          <br />
        ...
        <p
          ...
          style={{ animationDelay: '0.2s', fontSize: 'clamp(1rem, 2.5vw, 1.25rem)' }}
        >
        ...
        >
          Sandharka-2, Arghakhanchi, Nepal — Where young minds flourish amidst the green hills of Nepal
        </p>
