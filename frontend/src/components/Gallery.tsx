...
const gridImages = [
  ...
  {
    src: REAL_PHOTO_1,
    alt: 'Sandharka Green English Boarding School – School Entrance',
    label: 'School Entrance',
  },
  {
    src: REAL_PHOTO_2,
    alt: 'Sandharka Green English Boarding School – Academic Block',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-sans text-muted-foreground max-w-xl mx-auto text-sm sm:text-base">
            A glimpse into the vibrant life at Sandharka Green English Boarding School.
          </p>
          ...
          <div className="relative rounded-sm overflow-hidden shadow-hero group">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-sans text-gold-300 text-xs font-medium tracking-wider uppercase">Campus View</span>
              </div>
        ...
        {/* Grid of smaller images alternating both real photos */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {gridImages.map((img, i) => (
            <div key={i} className="relative rounded-sm overflow-hidden shadow-card group aspect-square">
              <img
                src={img.src}
                alt={img.alt}
              ...
              <div className="absolute bottom-0 left-0 right-0 px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="font-sans text-white text-xs font-medium">{img.label}</span>
              </div>
            </div>
          ))}
        </div>
