        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 sm:-right-6 bg-primary text-primary-foreground rounded-sm px-6 py-4 shadow-card">
              ...
              <div className="font-sans text-xs tracking-wider uppercase opacity-80">
                Established B.S.
              </div>
            </div>
            {/* Decorative border */}
          ...
          <div className="space-y-6">
            ...
            <p className="font-sans text-muted-foreground leading-relaxed">
              Sandharka Green English Boarding School was established in 2063
              B.S. with a vision to provide quality English-medium education to
              the children of Arghakhanchi and surrounding districts. Nestled
              amidst the lush green hills of Sandharka-2, our school has grown
              into one of the most respected educational institutions in the
              region.
            </p>
            <p className="font-sans text-muted-foreground leading-relaxed">
              Our campus is a vibrant community of over 1,500 students and 55
              dedicated teachers, all working together to create an environment
              where academic achievement, character development, and holistic
              ...
              {[
                {
                  ...
                  desc: "Quality education in English from early grades",
                },
                {
                  icon: MapPin,
                  title: "Arghakhanchi, Nepal",
                  desc: "Sandharka-2, surrounded by natural beauty",
                },
                {
                  icon: Award,
                ...
                },
                {
                  ...
                  desc: "Safe and nurturing residential environment",
                },
              ].map(({ icon: Icon, title, desc }) => (
                <div
                  key={title}
                  className="flex gap-3 p-4 bg-secondary rounded-sm border border-border hover:border-primary/30 transition-colors"
                >
